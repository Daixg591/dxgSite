package com.shahenpc.app.controller.personel;
...
@RestController
@Api(tags = "app通知 Done √")
@RequestMapping("/app/personnel/notice")
public class AppPersonnelAppointNoticeController extends BaseController {
    @Autowired
    ...
    @ApiOperation("查询-轮播广告")
    @GetMapping("/banner/list")
    public TableDataInfo bannerList(PersonnelAppointNotice personnelAppointNotice) {
        startPage();
        personnelAppointNotice.setBanner(1);
        List<PersonnelAppointNotice> list = personnelAppointNoticeService.selectPersonnelAppointNoticeList(personnelAppointNotice);
        return getDataTable(list);
    }
